...
AdminRouter
  ...
  .get("/billing-stats", callAction(AdminController, "getBillingStats"))
  ...
  .get("/promo-codes", callAction(AdminController, "getPromoCodes"))
  .post("/promo-codes", callAction(AdminController, "createPromoCode"))
  .patch("/promo-codes/:id", callAction(AdminController, "updatePromoCode"))
  .get("/promo-codes/:id/redemptions", callAction(AdminController, "getPromoRedemptions"))
