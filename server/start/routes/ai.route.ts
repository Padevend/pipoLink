...
AiRouter
  ...
  .post("/sessions", authMiddleware, callAction(AiController, "createSession"))
  .delete("/sessions/:id", authMiddleware, callAction(AiController, "deleteSession"))
  .delete("/sessions/:id/messages/:messageId", authMiddleware, callAction(AiController, "truncateMessages"))
  .post("/sessions/:id/messages/:messageId/truncate", authMiddleware, callAction(AiController, "truncateMessages"))
